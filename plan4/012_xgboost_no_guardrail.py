...
# from prediction_guardrails import PredictionGuardrailMonitor, apply_distribution_adjustment  # DISABLED
...
class XGBoostOptimizer:
    ...
    def train_final_model(self, X_train, y_train, X_test=None, params=None):
        ...
        if X_test is not None:
            ...
            # Guardrails completely DISABLED on test predictions
            # No guardrail checking or adjustment applied
